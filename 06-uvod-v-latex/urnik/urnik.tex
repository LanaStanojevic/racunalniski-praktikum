...
\section[short]{Program za izdelavo urnika} 
...
\subsection[short]{Vhodni podatki} 
...
vsebuje metode za delo z XML datotekami.opišemo sji zamaknjeni odstavki so elementi neoštevilčenega seznama.
...
tip (npr. \textsc{bool} v C++), kjer bi vrednost \textsc{true} predstavljala
dosegljivost, \textsc{false}  pa zasedenost.

 \subsection[short]{Omejitve}
...
\paragraph[short]{Stroge omejitve}
...
sicer se vstavljanje ne izvede.
 ...
 \paragraph[short]{Šibke omejitve}
...
saj bo njihov končni produkt le tako zadovoljil profesorje in študente.
 ...
 \subsection[short]{Merjenje kakovosti}
...
kateri predavalnici se bo izvajalo.
 ...
 \subsection[short]{Požrešna metoda}
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   Naslednja vgnezdena zanka nas popelje po vseh predavalnicah. Predavalnico na
    \(j\)-tem koraku označimo s  \(predavlanica_j\).
   ...
   Ko preverimo vse proste termine vseh predavalnic, vstavimo  \(srecanje_i\)
 ...
 \subsection[short]{Optimizacijske metode}
...
se podajmo v naslednje vrstice.
 ...
 \paragraph[short]{Lokalno vzpenjanje}
...
\paragraph[short]{Iskanje s tabuji }
...
kot uspešna.
 ...
 \subsection[short]{Končni algoritem}
